...
OPENFHE_CMAKE_ARGS=${OPENFHE_CMAKE_ARGS}" -DBUILD_STATIC=ON -DBUILD_SHARED=OFF"
...
OPENFHE_PYTHON_CMAKE_ARGS=${CMAKE_DEFAULT_ARGS}" -DBUILD_STATIC=ON -DBUILD_SHARED=OFF"
